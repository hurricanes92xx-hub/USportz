...
object SportsBranding {
    val brands = listOf(
        ...
        SportsBrand("ncaa-football", "NCAA Football", listOf("ncaa football", "college football"), "NCAA", "COLLEGE"),
        ...
        SportsBrand("ncaa-basketball", "NCAA Basketball", listOf("ncaa basketball", "college basketball"), "NCAA", "COLLEGE"),
        ...
        SportsBrand("mls", "MLS", listOf("mls", "major league soccer"), "MLS", "PRO"),
        SportsBrand("epl", "Premier League", listOf("epl", "premier league", "england premier league"), "EPL", "SOCCER"),
        ...
        SportsBrand("wwe", "WWE", listOf("wwe", "raw", "smackdown", "nxt"), "WWE", "WRESTLING"),
        ...
        SportsBrand("nascar", "NASCAR", listOf("nascar"), "NASCAR", "RACING"),
        SportsBrand("indycar", "INDYCAR", listOf("indycar"), "INDY", "RACING"),
        ...
        SportsBrand("golf", "Golf", listOf("pga", "lpga", "golf", "masters", "ryder cup"), "GOLF", "COURSE")
    )
