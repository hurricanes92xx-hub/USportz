...
object StreamClassifier {
    fun kind(url: String): StreamKind {
        ...
        return when {
            normalized.contains(".m3u8") || normalized.contains("m3u8") || normalized.contains("/hls/") -> StreamKind.HLS
            normalized.contains(".ts") || normalized.contains("/ts/") -> StreamKind.MPEG_TS
